...
// import { AuthManagerService } from '../auth/auth.manager.service'; // Adjust the path as needed
...
//   constructor(private http: HttpClient, private authManagerService: AuthManagerService) {}
