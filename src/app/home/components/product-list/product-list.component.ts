...
export class ProductListComponent implements OnInit {
  ...
  cameras: Product[] = [
    ...
    },
    {
      ...
      price: 300,
      imageUrl:
        'https://images.pexels.com/photos/274973/pexels-photo-274973.jpeg?cs=srgb&dl=pexels-pixabay-274973.jpg&fm=jpg',
    },
    {
      id: 3,
      name: 'Camera Tripod',
      ...
      price: 150,
      imageUrl:
        'https://i.natgeofe.com/n/cae95353-dd17-41f9-85f3-9699745e7ce9/MM10326_20241009_0001.jpg',
    },
  ];
  ...
  watches: Product[] = [
    {
      ...
      price: 200,
      imageUrl:
        'https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-pixabay-190819.jpg&fm=jpg',
    },
    {
      id: 5,
      name: 'Analog Watch',
    ...
    },
    {
      ...
      price: 80,
      imageUrl:
        'https://images.pexels.com/photos/125779/pexels-photo-125779.jpeg?cs=srgb&dl=pexels-pixabay-125779.jpg&fm=jpg',
    },
  ];
  ...
  shoes: Product[] = [
    {
      ...
      price: 120,
      imageUrl:
        'https://assets.ajio.com/medias/sys_master/root/20241104/ew9I/6728b3d7260f9c41e8bcdfc0/-1117Wx1400H-466481202-grey-MODEL3.jpg',
    },
    {
      id: 8,
      name: 'Formal Shoes',
      ...
      price: 150,
      imageUrl:
        'https://alonzoshoes.in/cdn/shop/files/DSC_0720.jpg?v=1703764708&width=1946',
    },
    {
      id: 9,
      name: 'Sneakers',
